...
class RandomForrest():
    ...
    def validation_processing(self,roi_v,class_prediction,roi,doc,model_path,Image_savePath):
        try:
            rt = ReportModule()
           ...
           # print('Our X matrix is sized: {sz_v}'.format(sz_v=X_v.shape))
            ...
            doc = rt.Clf_prepare_section3(doc,X_v,y_v,convolution_mat,df_sum_mat,score,roi_v,model_path,Image_savePath)
            return doc
        except ValueError as e:
            print(e)
